...
class OldLoginScreen extends StatefulWidget {
  ...
  @override
  OldLoginScreenState createState() => OldLoginScreenState();
}

class OldLoginScreenState extends State<OldLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset:
          true, // This will help in adjusting the layout when the keyboard opens
      appBar: AppBar(
        title: const Text(
          'Login',
